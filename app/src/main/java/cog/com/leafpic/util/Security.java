...
public class Security {
    ...
    public static void authenticateUser(final ThemedActivity activity, final AuthCallBack passwordInterface) {
        ...
        final View view = activity.getLayoutInflater().inflate(cog.com.leafpic.R.layout.dialog_password, null);
        final TextView passwordDialogTitle = view.findViewById(cog.com.leafpic.R.id.password_dialog_title);
        final CardView passwordDialogCard = view.findViewById(cog.com.leafpic.R.id.password_dialog_card);
        final EditText editTextPassword = view.findViewById(cog.com.leafpic.R.id.password_edittxt);
