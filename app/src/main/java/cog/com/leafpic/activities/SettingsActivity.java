...
import cog.com.leafpic.settings.CardViewStyleSetting;
import cog.com.leafpic.settings.ColorsSetting;
import cog.com.leafpic.settings.GeneralSetting;
import cog.com.leafpic.settings.MapProviderSetting;
import cog.com.leafpic.settings.SinglePhotoSetting;
import cog.com.leafpic.util.Security;
import cog.com.leafpic.views.SettingWithSwitchView;
...
public class SettingsActivity extends ThemedActivity {
    ...
    public void updateUiElements() {
        ...
        findViewById(cog.com.leafpic.R.id.setting_background).setBackgroundColor(getBackgroundColor());
        setStatusBarColor();
        setNavBarColor();
        setRecentApp(getString(cog.com.leafpic.R.string.settings));
    }
