...
import cog.com.leafpic.data.filter.ImageFileFilter;
...
import static cog.com.leafpic.data.MediaHelper.scanFile;
...
public class BlackWhiteListActivity extends SharedMediaActivity {
    ...
    public void updateUiElements(){
        ...
        findViewById(cog.com.leafpic.R.id.rl_ea).setBackgroundColor(getBackgroundColor());
    }
