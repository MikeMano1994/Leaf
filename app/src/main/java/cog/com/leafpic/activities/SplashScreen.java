...
public class SplashScreen extends SharedMediaActivity {
    ...
    public final static String ACTION_OPEN_ALBUM = "cog.com.leafpic.OPEN_ALBUM";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cog.com.leafpic.R.layout.activity_splash);
    ...
    public void setNavBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ColorPalette.getTransparentColor(
                    ContextCompat.getColor(getApplicationContext(), cog.com.leafpic.R.color.md_black_1000), 70));
        }
    }
    ...
    public void updateUiElements() {
        ...
        findViewById(cog.com.leafpic.R.id.Splah_Bg).setBackgroundColor(getBackgroundColor());
    }
}
