package cog.com.leafpic.adapters;
...
import cog.com.leafpic.CardViewStyle;
...
import cog.com.leafpic.data.sort.AlbumsComparators;
...
public class AlbumsAdapter extends ThemedAdapter<AlbumsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        RequestOptions options = new RequestOptions()
                ...
                .error(cog.com.leafpic.R.drawable.ic_error)
