...
import cog.com.leafpic.activities.DonateActivity;
import cog.com.leafpic.util.AlertDialogsHelper;
import cog.com.leafpic.util.ApplicationUtils;
import cog.com.leafpic.util.ChromeCustomTabs;
import cog.com.leafpic.util.preferences.Prefs;

import static cog.com.leafpic.util.ServerConstants.GITHUB_CALVIN;
import static cog.com.leafpic.util.ServerConstants.GITHUB_DONALD;
import static cog.com.leafpic.util.ServerConstants.GITHUB_GILBERT;
import static cog.com.leafpic.util.ServerConstants.GITHUB_LEAFPIC;
import static cog.com.leafpic.util.ServerConstants.GOOGLE_ABOUT_CALVIN;
import static cog.com.leafpic.util.ServerConstants.LEAFPIC_CROWDIN;
import static cog.com.leafpic.util.ServerConstants.LEAFPIC_ISSUES;
import static cog.com.leafpic.util.ServerConstants.LEAFPIC_LICENSE;
import static cog.com.leafpic.util.ServerConstants.MAIL_CALVIN;
import static cog.com.leafpic.util.ServerConstants.MAIL_DONALD;
import static cog.com.leafpic.util.ServerConstants.MAIL_GILBERT;
import static cog.com.leafpic.util.ServerConstants.TWITTER_ABOUT_DONALD;
import static cog.com.leafpic.util.ServerConstants.TWITTER_ABOUT_GILBERT;
